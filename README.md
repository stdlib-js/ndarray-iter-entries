...
```javascript
import nditerEntries from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-iter-entries@v0.1.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/ndarray-iter-entries/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/ndarray-iter-entries/actions/workflows/test.yml?query=branch:v0.1.0
